...
urlpatterns = [
    ...
    path('user-candidates-limited-experiment', views.UserCandidatesInstitutionLimitedList.as_view(), name='user_candidates_limited_institution'),
    path('user-candidates-limited-experiment/<int:institution_id>/', views.UserCandidatesInstitutionLimitedList.as_view()),
