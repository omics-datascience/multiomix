...
urlpatterns = [
    ...
    path('<int:pk>/update', views.DifferentialExpressionUpdate.as_view(), name='differential_expression_update'),
    path('<int:pk>/delete', views.DifferentialExpressionDelete.as_view(), name='differential_expression_delete'),
