...
urlpatterns = [
    ...
    path('volcano-data/<int:pk>/', views.DifferentialExpressionVolcanoData.as_view(), name='differential_expression_volcano_data'),
    ...
    path('download-results/<int:pk>/', views.download_differential_expression_results, name='download_differential_expression_results'),
