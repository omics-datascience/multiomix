        ...
        <Grid stackable>
          <Grid.Row columns={1}>
            <Grid.Column>
              ...
              <Segment id="datasets" basic>
                <Header as='h2'>How are cBioPortal datasets incorporated and preprocessed?</Header>
                <p>
              ...
              <Segment id="privacy" basic>
                <Header as='h2'>How is user-uploaded data privacy handled?</Header>
                <p>
              ...
              <Segment id="licenses" basic>
                <Header as='h2'>Libraries and Tools with Licenses</Header>
                <p>
              ...
              <Segment id="footer" basic>
                <Header as='h2'>Additional Links</Header>
