export default {
    ...
    'inference.timeTable.columns.predictedTime': 'Prediction',
    ...
    'inference.timeTable.menu.table.info': 'Table with each sample and its model prediction',
    ...
    'geneOntology.form.generalDepth.info': 'Maximum graph depth around the term. Larger values show more distant related terms; smaller values keep the view focused. Neither is inherently better.',
    'geneOntology.form.hierarchicalDepth': 'Hierarchical depth to children',
    'geneOntology.form.hierarchicalDepth.info': 'How many descendant levels to show. Larger values include more child terms but make the graph denser; neither is inherently better.',
    ...
    'geneOntology.panel.pValueThreshold.info': 'Maximum p-value accepted for enrichment. A smaller threshold is stricter and returns fewer terms; a larger one is more permissive.',
    ...
    'geneAssociations.infoPopup.text': 'Higher STRING combined scores mean greater confidence that an association exists, not a stronger biological effect. A higher minimum shows fewer, higher-confidence links. See',
    ...
    'statValidationBestFeatures.context.features': 'Cox coefficients found for this statistical validation',
    ...
    'statValidationMenu.bestFeatures': 'Largest absolute Cox coefficients',
    'statValidationMenu.bestFeatures.info': 'Molecules with the largest absolute Cox coefficients. Magnitude indicates association strength per unit, not statistical significance.',
    'statValidationMenu.kaplanMeier': 'Kaplan-Meier',
    'statValidationMenu.kaplanMeier.info': 'Estimated survival probability over time by group. A higher curve means greater estimated survival at the same time.',
    'statValidationMenu.heatmap': 'Heatmap',
    'statValidationMenu.heatmap.info': 'Molecule measurements by sample. Colors show lower and higher values on the displayed scale; their desirability depends on context.',
    ...
    'newClusteringForm.info.scoringMethod': 'C-Index ranks survival outcomes; higher is better (0.5 is near chance). Cox partial log-likelihood measures fit; higher (less negative) is better for the same data.',
    ...
    'biomarkerTrainedModelsTable.header.bestCVMetric': 'Best model score',
    ...
    'metricInfo.mse': 'Mean squared difference between model output and observed survival time. Lower is better (0 is exact), but a risk score is not a time prediction; compare only like for like.',
    'metricInfo.cIndex': 'How well predicted risk ranks comparable survival outcomes. About 0.5 is chance; 1 is perfect. Higher is better.',
    'metricInfo.r2': 'Fit of model output to observed survival time: 1 is exact, 0 matches predicting the mean, and negative is worse. Interpret cautiously when output is a risk score.',
    'metricInfo.partialLogLikelihood': 'Average Cox partial log-likelihood. Higher (less negative) means better fit on the same data; scores from different datasets are not directly comparable.',
    'metricInfo.coxCoefficient': 'Cox log-hazard coefficient: positive means higher molecule values are associated with higher risk; negative means lower risk. Larger absolute values mean stronger per-unit association, not necessarily better outcomes.',
    'metricInfo.expression.label': 'Molecule values',
    'metricInfo.expression': 'Each cell is a molecule measurement in one sample. Higher or lower is not universally better; compare values for the same molecule and measurement scale.',
    'metricInfo.clusterId': 'Arbitrary group identifier. A larger number does not mean better, worse, or higher risk; compare the groups\' survival curves.',
    'metricInfo.inferencePrediction': 'Random Forest and ranking SVM return risk scores: higher means greater predicted event risk. Regression SVM returns transformed survival-time scores: higher suggests longer survival. Compare only within the same model.',
    'trainedModels.info.fitnessMetric': 'The score used to select the model: C-Index ranks survival risk; Cox partial log-likelihood measures fit. Both favor higher values.',
    'trainedModels.info.bestScore': 'Score recorded for the selected model during training or validation. Higher is better for these metrics; compare models on the same data and metric.',
    'modelDetails.info.model': 'Algorithm used to generate predictions; the label itself has no better or worse direction.',
    'modelDetails.info.bestCIndex': 'C-Index recorded for the selected model during training or validation. Higher is better; about 0.5 is chance and 1 is perfect.',
    'modelDetails.info.bestClusteringCIndex': 'Cox C-Index recorded for the selected clustering model during training or validation. Higher is better; about 0.5 is chance.',
    'modelDetails.info.bestLogLikelihood': 'Cox partial log-likelihood recorded for the selected clustering model during training or validation. Higher (less negative) is better on the same data.',
    'modelDetails.info.randomState': 'Random seed used to reproduce a run. A larger or smaller number does not mean better performance.',
    'modelDetails.info.algorithm': 'Clustering method used to form groups. No method is always better; compare validation results.',
    'modelDetails.info.scoringMethod': 'Score used to select cluster settings: higher C-Index or higher Cox partial log-likelihood is better on the same data.',
    'modelDetails.info.nClusters': 'Number of groups formed. More groups give finer divisions, but do not necessarily improve survival separation.',
    'modelDetails.info.kernel': 'SVM similarity function. Its name has no score direction; compare validation performance.',
    'modelDetails.info.task': 'Ranking predicts relative risk; regression predicts transformed survival time. The task label has no better or worse direction.',
    'modelDetails.info.nEstimators': 'Number of trees in the forest. More trees can stabilize predictions but cost more computation; more is not always better.',
    'modelDetails.info.maxDepth': 'Maximum tree depth. Greater depth allows more complex patterns but can overfit; no universal best value.',
    ...
    'files.manager.sharedInstitutions.action': 'Manage shared institutions',
    'files.manager.sharedInstitutions.title': 'Dataset shared institutions',
    'files.manager.sharedInstitutions.select': 'Select an institution to share',
    'files.manager.sharedInstitutions.add': 'Add institution',
    'files.manager.sharedInstitutions.addTitle': 'Share dataset',
    'files.manager.sharedInstitutions.addConfirm': 'Are you sure you want to share this dataset with the institution?',
    'files.manager.sharedInstitutions.remove': 'Remove institution',
    'files.manager.sharedInstitutions.removeTitle': 'Stop sharing dataset',
    'files.manager.sharedInstitutions.removeConfirm': 'Are you sure you want to stop sharing this dataset with the institution?',
    ...
    'miRNAInteractionPanel.mirDIPScoreInfo': 'Higher mirDIP scores mean greater confidence in a predicted miRNA–gene interaction; lower scores mean weaker evidence. A prediction is not experimental proof.',
